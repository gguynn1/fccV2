...
Does not make routing decisions — primarily shapes how the message sounds

Also provides a fallback classification path when the primary classifier is unavailable
