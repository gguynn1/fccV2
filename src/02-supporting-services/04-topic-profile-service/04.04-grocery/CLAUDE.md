...
Shared household list. Add items, organize by section, read back the current list, mark items purchased.

Routes to the broadest shared thread for shared lists, or responds in whatever thread someone adds an item from.
