...
function createWorkerOptions(hooks: {
  ...
  return {
    ...
    state_service: {
      ...
      getSystemState: () =>
        resolved({
          queue: { pending: [], recently_dispatched: [] },
          outbound_budget_tracker: { entries: [] },
          ...
          confirmations: { pending: [], recent: [] },
          threads: {},
          data_ingest_state: { email_monitor: {}, calendar_sync: {}, forwarded_messages: {} },
          digests: { history: [] },
        } as never),
