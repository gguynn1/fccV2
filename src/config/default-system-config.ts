...
export const defaultTopics: SystemConfig["topics"] = {
  calendar: {
    label: "Calendar",
...
export const defaultDispatch: SystemConfig["dispatch"] = {
  priority_levels: {
    immediate: {
...
export const defaultEscalationProfiles: SystemConfig["escalation_profiles"] = {
  high: {
...
export const defaultConfirmationGates: SystemConfig["confirmation_gates"] = {
...
export const defaultInputRecognition: SystemConfig["input_recognition"] = {
  text: {
    description:
...
export const defaultWorker: SystemConfig["worker"] = {
  processing_sequence: [
    {
      step: 1,
...
export const defaultDataIngest: SystemConfig["data_ingest"] = {
  sources: [
    {
      id: "email_monitor",
