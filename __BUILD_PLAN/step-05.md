...
- `src/02-supporting-services/01-scheduler-service/types.ts` — scheduled event types, daily rhythm configuration, digest window definitions
...
- Morning digest fires at configured time
