...
Initiative is deadline-driven: reminders as assignments approach due dates, summaries of school communications when they arrive, and flags when something is overdue. Escalation goes from the child's thread to a parent's thread if something important is being ignored.
